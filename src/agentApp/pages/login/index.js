...
let oauth = {
  domain:
    "presolvedtenant0632935b-0632935b-qa.auth.us-east-1.amazoncognito.com",
  scope: [
  ...
  redirectSignIn:
    "https://localhost:3000/login/,https://d3tatipwtorp0c.cloudfront.net/login",
  redirectSignOut:
    "https://localhost:3000/login/,https://d3tatipwtorp0c.cloudfront.net/login",
  responseType: "code",
...
const [localRedirectSignIn, productionRedirectSignIn] =
  oauth?.redirectSignIn.split(",") || "https://d3tatipwtorp0c.cloudfront.net";
const [localRedirectSignOut, productionRedirectSignOut] =
  oauth?.redirectSignOut.split(",") || "https://d3tatipwtorp0c.cloudfront.net";
            ...
            <Card>
              ...
              <div>
                <Typography.Title
                  ...
                  level={3}
                >
                  Authentication is required to access the portal
                </Typography.Title>
