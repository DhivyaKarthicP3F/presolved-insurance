...
import popupImage from '../../assets/images/animated/phone.gif'
            ...
            <section className="customCCP">
                ...
                </Modal>
                {
                    ...
                    <div className='container'  >
                        <div style={{ display: state.activeCall && state.activeCall.type == 'chat' ? '' : 'none' }}>
                            <div style={{ float: 'right' }}>
                                <Space>
                                    <Button type='primary' size='large' shape='circle' icon={showChat ? <LineOutlined size={30} /> : <BorderOutlined />} onClick={() => setShowChat(!showChat)} />
                                </Space>
                            </div>
                        </div>
                        <div style={{  display: showChat ? '' : 'none ' }}>
                            <div ref={ccp} style={{ height: 600, visibility: 'visible' }}></div>
                        </div>
                    </div>
                }
